  ...
  <c:out value="${sessionScope.r.payment_succeed }"></c:out>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <a class="btn btn-primary" href="getrecu"><c:out value="${sessionScope.r.recu_download} version PDF"></c:out></a>
            <a class="btn btn-success" href="GetEcxelRecu"><c:out value="${sessionScope.r.recu_download} version Ecxel"></c:out></a>
